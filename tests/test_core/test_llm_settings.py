...
def test_settings_apply_overrides() -> None:
    ...
    settings = Settings(
        llm_base_url="http://original-base", llm_api_key="original-key", llm_model="original-model"
    )

    settings.apply_overrides(base_url="http://new-base", api_key="new-key", model="new-model")
...
def test_settings_apply_overrides_masked_key() -> None:
    ...
    settings.apply_overrides(base_url="http://new-base", api_key="••••••••", model="new-model")
