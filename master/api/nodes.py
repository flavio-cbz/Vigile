    ...
    if is_demo(claims):
        for nd in node_dicts:
            if nd["id"] == "demo-node-01":
                nd.update({"cpu_percent": 12.5, "memory_percent": 45.2, "disk_percent": 38.4, "uptime_seconds": 3600.0})
            elif nd["id"] == "demo-node-02":
                nd.update({"cpu_percent": 8.0, "memory_percent": 30.1, "disk_percent": 42.0, "uptime_seconds": 1800.0})
        return node_dicts
